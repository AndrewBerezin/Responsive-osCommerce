...
# @copyright Copyright 2003-2018 osCommerce
# @license http://www.zen-cart.com/license/2_0.txt GNU Public License V2.0
# @Localization: Andrew Berezin http://ecommerce-service.com
# @version $Id: mysql_ru.sql 2.1.2 11.03.2018 19:51:13 AndrewBerezin $

# Prepare tables for Localization
...
ALTER TABLE categories_description CHANGE categories_seo_title categories_seo_title VARCHAR(255);
ALTER TABLE zones CHANGE zone_name zone_name VARCHAR(128);

# Add ru language and set it as default languages
...
UPDATE configuration_group SET configuration_group_title = 'Мой магазин', configuration_group_description = 'Основные настройки магазина.' WHERE configuration_group_id = 1;
...
UPDATE configuration_group SET configuration_group_title = 'Bootstrap', configuration_group_description = 'Основные параметры Bootstrap' WHERE configuration_group_id = 16;
...
UPDATE `configuration` SET `configuration_title`='Сортировка' WHERE `configuration_title`='Sort Order';
UPDATE `configuration` SET `configuration_description`='Порядок сортировки' WHERE `configuration_description`='Sort order of display. Lowest is displayed first.';
UPDATE `configuration` SET `configuration_description`='Добавить модуль?' WHERE `configuration_description`='Do you want to add the module to your shop?';
UPDATE `configuration` SET `configuration_description`='Модуль показывать в левой или правой колонке?' WHERE `configuration_description`='Should the module be loaded in the left or right column?';
UPDATE `configuration` SET `configuration_title`='Ширина' WHERE `configuration_title`='Content Width';
UPDATE `configuration` SET `configuration_description`='Укажите ширину. 12 - полная ширина, 6 - половина.' WHERE `configuration_description`='What width container should the content be shown in? (12 = full width, 6 = half width).';
UPDATE `configuration` SET `configuration_title`='Разрешить заказы не соответствующие определённым зонам доставки' WHERE `configuration_key`='SHIPPING_ALLOW_UNDEFINED_ZONES';
UPDATE `configuration` SET `configuration_description`='Разрешить заказы не соответствующие определённым зонам доставки?' WHERE `configuration_key`='SHIPPING_ALLOW_UNDEFINED_ZONES';
UPDATE `configuration` SET `configuration_title`='Адрес магазина' WHERE `configuration_key`='STORE_ADDRESS';
UPDATE `configuration` SET `configuration_description`='Адрес магазина используется на печатных документах и отображается на сайте' WHERE `configuration_key`='STORE_ADDRESS';
UPDATE `configuration` SET `configuration_title`='Телефон магазина' WHERE `configuration_key`='STORE_PHONE';
UPDATE `configuration` SET `configuration_description`='Телефон магазина используется на печатных документах и отображается на сайте' WHERE `configuration_key`='STORE_PHONE';
...
# Translate countries
# @link http://www.iso.org/iso/en/prods-services/iso3166ma/02iso-3166-code-lists/list-en1.html
# @link http://www.magnum-opus.ru/wiki/ISO-3166-1
# @link http://www.artlebedev.ru/tools/country-list/tab/
...
# Add zones for Russian Federation countries
...
INSERT INTO tax_rates VALUES (3, 1, 3, 3, 0.0000, 'НДС не облагается', NULL, now());
# Add RUR currencies (Rating based on USD).
