...
*/
  ...
  define('MODULE_PAYMENT_AUTHORIZENET_CC_SIM_TEXT_AVS_R', 'Retry вЂ“ System unavailable or timed out');
  ...
  define('MODULE_PAYMENT_AUTHORIZENET_CC_SIM_TEXT_CAVV_7', 'CAVV attempt вЂ“ failed validation вЂ“ issuer available (U.S.-issued card/non-U.S. acquirer)');
  define('MODULE_PAYMENT_AUTHORIZENET_CC_SIM_TEXT_CAVV_8', 'CAVV attempt вЂ“ passed validation вЂ“ issuer available (U.S.-issued card/non-U.S. acquirer)');
  define('MODULE_PAYMENT_AUTHORIZENET_CC_SIM_TEXT_CAVV_9', 'CAVV attempt вЂ“ failed validation вЂ“ issuer unavailable (U.S.-issued card/non-U.S. acquirer)');
  define('MODULE_PAYMENT_AUTHORIZENET_CC_SIM_TEXT_CAVV_A', 'CAVV attempt вЂ“ passed validation вЂ“ issuerunavailable (U.S.-issued card/non-U.S. acquirer)');
